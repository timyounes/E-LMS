...
<li class="tooltips active" data-container="body" data-placement="right" data-html="true" data-original-title="View Quiz Records">
...
<div class="caption">
<i class="fa fa-edit"></i>Quiz Results List
</div>
<div class="tools">
...
$query=mysql_query("select * from quiz_result where instructor_id='$id1'")or die(mysql_error());
if($num=mysql_num_rows($query)>0)
{
...
<td class='center'>
<?php echo $rows['points'];?>
</td>
<td class='center'>
<?php echo $rows['num_question'];?>
</td>
<td class='center'>
<?php echo $rows['date'];?>
</td>
...
<div class="col-md-6">
<a href="../function/delete_student_quiz.php<?php echo '?id='.$code;?>" class="btn blue"> 
