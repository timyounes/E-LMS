									...
									<div class="col-md-9">
										<div class="tab-content">
											<div id="tab_1-1" class="tab-pane active">
												<form action="../function/updateprofile_instructor.php" method="post" enctype="multipart/form-data" id="">
									...
									<div class="col-md-offset-4 col-md-5">
										...
										<button type="submit" class="btn green" name="save"><i class="fa fa-save"></i> Save Changes</button>
											...
											<div id="tab_2-2" class="tab-pane">
												...
												<form action="../function/changepic_instructor.php" method="post"  enctype="multipart/form-data">
													<div class="form-group" >
											...
											<div id="tab_3-3" class="tab-pane">
												<form action="../function/changepass_instructor.php" id="" method="post">
										<div class="alert alert-danger display-hide">
										<button class="close" data-close="alert"></button>
										You have some form errors. Please check below.
									</div>
