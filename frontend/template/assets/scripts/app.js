var App = function () {
    ...
    var handleTheme = function () {
        ...
        var setColor = function (color) {
            $('#style_color').attr("href", "frontend/template/assets/css/themes/" + color + (isRTL ? '-rtl' : '') + ".css");
            $('#logoimg').attr("src", "frontend/template/assets/img/logo_" + color + ".png");
            $('#rev-hint1').attr("src", "frontend/template/assets/img/sliders/revolution/hint1-" + color + ".png");
            $('#rev-hint2').attr("src", "frontend/template/assets/img/sliders/revolution/hint2-" + color + ".png");
        }
