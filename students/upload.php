	...
	<div class="page-sidebar-wrapper">
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu" data-auto-scroll="true" data-slide-speed="200">
				...
				<li class="active tooltips" data-container="body" data-placement="right" data-html="true" data-original-title="Upload your activty">
					<a href="upload.php">
...
<div class="center ">
<form action="../function/file_upload.php" enctype="multipart/form-data" class="form-horizontal" method="post">
	<div class="form-body">
...
<div class="portlet box blue">
	<div class="portlet-title">
		<div class="caption">
		<i class="fa fa-edit"></i>Your uploaded activities
							</div>
							<div class="tools">
...
<table class='table table-striped table-hover table-bordered' id='sample_editable_1'>
			...
			<?php
				...
				$query=mysql_query("select * from file_activity where student_id='$id1' order by date asc")or die("Error");
					...
					?>	
						<tr>								
							 ...
							 <?php echo $row['time'];?>
								...
								<a href="#id<?php echo $user_id;?>" data-toggle="modal" class="btn blue tooltips" title="View Activity"> 
								<i class='glyphicon glyphicon-eye-open'></i></a>
							<div id="id<?php echo $user_id;?>" class="modal fade modal-scroll container" tabindex="-1" data-backdrop="static" data-keyboard="false" aria-hidden="true">
								 		<div class="modal-body">
									<h4 class="center">
										 Your Activity
									</h4>
									<embed src="../activity/<?php echo $row['activity'];?>" width="100%" height="500px" wmode="" type="application/x-shockwave-flash"></embed>
										</div>
								<div class="modal-footer">
