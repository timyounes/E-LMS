			...
			<ul class="page-sidebar-menu" data-auto-scroll="true" data-slide-speed="200">
				...
				<li class="active tooltips" data-container="body" data-placement="right" data-html="true" data-original-title="">
					...
					<ul class="sub-menu">
						...
						<li class="tooltips active" data-container="body" data-placement="right" data-html="true" data-original-title="Take your quiz no. 2">
							<a href="quiz2.php">
							<i class="fa fa-file-text"></i>
								<span class="title">
									Quiz No. 2
...
<form action="../function/quiz_process2.php" method="post" enctype="multipart/form-data">
	<div class="form-group margin-bottom-20">
		<div class="input-icon right col-md-3">
			<i class="fa"></i>
			<input type="text" class="form-control" name="answer1" required />
		</div>
		<h4>1. Is the white, rectangular area of the Adobe Flash Professional CS5 workspace.</h4>
	</div>
	<div class="form-group margin-bottom-20">
		<div class="input-icon right col-md-3">
			<i class="fa"></i>
		...
		<h4>2. In the Timeline provide a way to organize the elements of your movie.</h4>
	</div>
	<div class="form-group margin-bottom-20">
		<div class="input-icon right col-md-3">
			<i class="fa"></i>
		...
		<h4>3. Is where you control the images and sounds in your Flash document and divided into frames.</h4>
	</div>
	<div class="form-group margin-bottom-20">
		<div class="input-icon right col-md-3">
			<i class="fa"></i>
		...
		<h4>4. It let’s you draw, paint, select, and modify artwork, as well as change the view of the Stage.</h4>
	</div>
	<div class="form-group margin-bottom-20">
		<div class="input-icon right col-md-3">
			<i class="fa"></i>
		...
		<h4>5. Located at the top of the Stage, lets you quickly navigate between different parts of your Flash document.</h4>
	</div>
	<div class="form-group margin-bottom-20">
		<div class="input-icon right col-md-3">
			<i class="fa"></i>
			<input type="text" class="form-control" name="answer6" required />
		</div>
		<h4>6. Provide easy access to controls that help you work with the content in your document.</h4>
	</div>
	<div class="form-group margin-bottom-20">
		<div class="input-icon right col-md-3">
			<i class="fa"></i>
			<input type="text" class="form-control" name="answer7" required />
		</div>
		<h4>7. Provides easy access to the most commonly used attributes of the current selection, either on the Stage or in the Timeline.</h4>
	</div>
