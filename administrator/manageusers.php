		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Manage Instructors Account<small></small>
					</h3>
			...
			<div class="row">
				...
				<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-edit"></i>List Of Instructors
							</div>
							<div class="tools">
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="btn-group">
									<button id="ajax-demo" class="btn green" data-toggle="modal">
									<i class="glyphicon glyphicon-plus"></i> Add New Information
									</button>
								</div>
							<!-- ajax -->
			...
			<?php
				...
				$query=mysql_query("select * from users where level='$level'")or die("Error");
				if($num=mysql_num_rows($query)>0)
				{
			while($row=mysql_fetch_assoc($query))
			{
				...
				?>
							<tr>
							<td class='center'>
							<img src="../instructors/images/profilepic/<?php echo $row['profilepic'];?> " class='imgs'>
								</td>							
								<td class='center'>
							...
							<?php echo $row['firstname']." ".$row['lastname'];?>
								...
								<td class='center'>
								<a href="#id<?php echo $user_id;?>" data-toggle="modal" class="btn red tooltips" title="Delete instructor's data"> 
							...
							<div id="id<?php echo $user_id;?>" class="modal fade" tabindex="-1" data-backdrop="static" data-keyboard="false" aria-hidden="true">
								...
								<div class="col-md-6">
								<a href="../function/delete_instructor.php <?php echo '?id='.$user_id;?>" class="btn blue"> 
								 <i class='glyphicon glyphicon-trash'></i> Delete this instructor</a>
								</div>
								</div>
							</div>
