...
if(isset($_POST['save']))
{
	...
	if ($num=mysql_num_rows($query)>0)
	{
			if($password==$cpass)
			{
				...
				{
				header("location:../administrator/myprofile.php?password_updated");
			...
			{
					header("location:../administrator/myprofile.php?password_mismatch");
					$_SESSION["success"]='not';
			}
	}
	else
	{
	header("location:../administrator/myprofile.php?undifined_password");
