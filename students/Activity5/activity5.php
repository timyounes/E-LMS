			...
			<ul class="page-sidebar-menu" data-auto-scroll="true" data-slide-speed="200">
				...
				<li class="tooltips active" data-container="body" data-placement="right" data-html="true" data-original-title="">
					...
					<ul class="sub-menu">
						...
						<li class="tooltips active" data-container="body" data-placement="right" data-html="true" data-original-title="Motion Tween">
							<a href="activity5.php">
							<i class="fa fa-clipboard"></i>
								<span class="title">
									Activity 5
								</span>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						<li>
							<a href="activity5.php">
								Take your evaluation about lesson 5
							</a>
						</li>
						<!--li class="pull-right">
