		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu" data-auto-scroll="true" data-slide-speed="200">
				...
				<li class="tooltips active" data-container="body" data-placement="right" data-html="true" data-original-title="">
					...
					<ul class="sub-menu">
						<li class="tooltips active" data-container="body" data-placement="right" data-html="true" data-original-title="Introduction to Multimedia System and Adobe Flash">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						<li>
							<a href="activity1.php">
								Take your evaluation about lesson 1
							</a>
						</li>
						<!--li class="pull-right">
...
<input type="hidden" id="userID" name="user_id" value="<?php echo $id1; ?>">
<div class="center margin-left-2">
<script>
...
var g_bUseHtml5 = false && g_bHtml5Supported;
...
<DIV id='divWebObjects'></DIV>
	...
	<div id="block" class="modal fade " tabindex="-1" data-backdrop="static" data-keyboard="false" aria-hidden="false">
		<div class="modal-body">
				<h4 class="center">
			...
			<div class="col-md-6">
				<a href="../function/delete_student_instructor.php <?php echo '?id='.$code;?>" class="btn blue"> 
...
<script type="text/javascript">
    $(window).load(function(){
    	...
    	<?php
    		$query=mysql_query("select activity1 from evaluation where student_id='$id1'");
    		if($num=mysql_num_rows($query)>0)
    		{
    			$row=mysql_fetch_assoc($query);
    			if($row['activity1']=="ACTIVATED")
